...
export default function CvReviewFormSection() {
  ...
  return (
    <section className="py-10 px-[120px] space-y-11 text-lg flex flex-col items-center">
      ...
      <Form {...form}>
        <form
          ...
          className="p-5 bg-black w-full relative rounded-lg grid grid-cols-3 gap-5"
        >
          <FormField
